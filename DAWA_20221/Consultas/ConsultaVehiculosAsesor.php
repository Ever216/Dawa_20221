        ...
        <nav class="navbar navbar-expand-sm navbar-dark bg-black py-0 px-0"> <a class="navbar-brand"  href="#"><img id="logo" src="../img/img_log.jpg"> &nbsp;&nbsp;&nbsp;NombreAgencia</a><span class="v-line"></span> 
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class=" navbar-nav nav nav-pills sm-3 " id="pills-tab" >
                    ...
                    <li class="nav-item active"> <a class="nav-link" href="../Consultas/ConsultaVehiculosAsesor.php">Info. Vehiculos</a> </li>
                    ...
                    <li class="nav-item dropdown ">
                        ...
                        <a class="dropdown-item" href="">Venta Piezas</a>
                        <a class="dropdown-item" href="">Venta Vehiculos</a>
                        </ul>
                    </li>
            ...
            echo"<div class='well well-sm card-body'>";
                ...
                echo "<thead>";
                echo "<tr><th>Numero de Serie</th><th>Numero de Serie</th><th>Marca del Vehiculo</th><th>Color del vehiculo</th><th>Precio por Unidad</th><th>Cantidad</th>";
                echo"</thead>";
